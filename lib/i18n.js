...
export const TRANSLATIONS = {
  ...
  'campaigns.delete.button_title': { ru: 'Удалить кампанию', en: 'Delete campaign' },
  'campaigns.delete.title':       { ru: 'Удалить кампанию?', en: 'Delete campaign?' },
  'campaigns.delete.body':        { ru: 'Все строки этой кампании будут безвозвратно удалены из data table. История review, edit-payloads и snapshots — стираются. Опубликованные в Storyblok блоки не трогаются (их нужно откатить ДО удаления, если требуется).', en: 'All rows for this campaign will be permanently deleted from the data table. Review history, edit payloads and snapshots are wiped. Already-published Storyblok blocks are not touched (roll them back BEFORE deleting if needed).' },
  'campaigns.delete.confirm_label': { ru: 'Введите ID кампании для подтверждения:', en: 'Type the campaign ID to confirm:' },
  'campaigns.delete.typed_mismatch': { ru: 'Введённый ID не совпадает', en: 'Typed ID does not match' },
  'campaigns.delete.submit':      { ru: 'Удалить навсегда', en: 'Delete permanently' },
  'campaigns.delete.submitting':  { ru: 'Удаляем…', en: 'Deleting…' },
  ...
  // ─── Block card extras ───────────────────────────────────────────────
  'block.open_live':         { ru: '📖 Открыть live',     en: '📖 Open live' },
  'block.open_live_title':   { ru: 'Открыть статью на сайте с переходом к этому фрагменту', en: 'Open the live article and jump to this fragment' },
  'block.open_storyblok':    { ru: '✏️ Storyblok',        en: '✏️ Storyblok' },
  'block.open_storyblok_title': { ru: 'Открыть story в Storyblok admin', en: 'Open the story in Storyblok admin' },
  'block.context_show':      { ru: '↕ Показать контекст', en: '↕ Show context' },
  'block.context_hide':      { ru: '↕ Скрыть контекст',   en: '↕ Hide context' },
  'block.context_prev':      { ru: '↑ Предыдущий блок',   en: '↑ Previous block' },
  'block.context_next':      { ru: '↓ Следующий блок',    en: '↓ Next block' },
  'block.context_none':      { ru: 'Контекст не найден',  en: 'No context found' },
  'block.context_section':   { ru: 'Секция',              en: 'Section' },
  'block.context_table_caption': { ru: 'Таблица',         en: 'Table' },
  'block.context_table_column':  { ru: 'Колонка',         en: 'Column' },
  'block.context_table_row':     { ru: 'Строка',          en: 'Row' },
  'block.context_loading':   { ru: 'Загружаем контекст…', en: 'Loading context…' },
